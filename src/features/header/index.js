    ...
    <div className="header">
      <div className="header-top">
        <div className="header-icon">
          <i className="fa-solid fa-bars icon-menu" onClick={openMenu}></i>
        </div>
        <div className="header-content">
            ...
            <ul>
              {menu.map((item, index) => (
                <li
                  key={index}
                  className={
                    check === item ? "header-nav-menu-focus" : "header-nav-menu"
                  }
                >
          ...
          <div className="button-sing-in">
            <button className="header-nav-menu-sing-in">{t("sing in")}</button>
          </div>
        </div>
      </div>
